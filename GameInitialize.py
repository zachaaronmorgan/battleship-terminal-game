...
#         break
player_1.place_ship('Carrier','A1','down')
player_1.place_ship('Battleship', 'A2','down')
player_1.place_ship('Cruiser','A3','down')
player_1.place_ship('Submarine','A4','down')
player_1.place_ship('Destroyer','A5','down')

player_1.display_friendly_board()
player_1.display_target_board()

player_2.place_ship('Carrier','A1','down')
player_2.place_ship('Battleship','A2','down')
player_2.place_ship('Cruiser','A3','down')
player_2.place_ship('Submarine','A4','down')
player_2.place_ship('Destroyer','A5','down')

player_2.display_friendly_board()
player_2.display_target_board()
...
while is_running:
    ...
    player_1.display_target_board()
    player_2.display_friendly_board()
    print(player_2.check_all_ships_destroyed())
